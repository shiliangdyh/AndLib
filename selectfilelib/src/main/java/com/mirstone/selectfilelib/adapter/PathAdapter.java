package com.mirstone.selectfilelib.adapter;
...
public class PathAdapter extends RecyclerView.Adapter<PathAdapter.PathViewHolder> {
    ...
    public PathViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = View.inflate(mContext, com.leon.lfilepickerlibrary.R.layout.lfile_listitem, null);
    ...
    public void onBindViewHolder(final PathViewHolder holder, final int position) {
        ...
        if (file.isFile()) {
            ...
            holder.tvDetail.setText(mContext.getString(com.leon.lfilepickerlibrary.R.string.lfile_FileSize) + " " + FileUtils.getReadableFileSize(file.length()));
            ...
            if (files == null) {
                holder.tvDetail.setText("0 " + mContext.getString(com.leon.lfilepickerlibrary.R.string.lfile_LItem));
            } else {
                holder.tvDetail.setText(files.size() + " " + mContext.getString(com.leon.lfilepickerlibrary.R.string.lfile_LItem));
            }
    ...
    private void updateFloaderIconStyle(ImageView imageView) {
        switch (mIconStyle) {
            case Constant.ICON_STYLE_BLUE:
                imageView.setBackgroundResource(com.leon.lfilepickerlibrary.R.mipmap.lfile_folder_style_blue);
                break;
            case Constant.ICON_STYLE_GREEN:
                imageView.setBackgroundResource(com.leon.lfilepickerlibrary.R.mipmap.lfile_folder_style_green);
                break;
            case Constant.ICON_STYLE_YELLOW:
                imageView.setBackgroundResource(com.leon.lfilepickerlibrary.R.mipmap.lfile_folder_style_yellow);
                break;
        }
    }
    ...
    private void updateFileIconStyle(ImageView imageView) {
        switch (mIconStyle) {
            case Constant.ICON_STYLE_BLUE:
                imageView.setBackgroundResource(com.leon.lfilepickerlibrary.R.mipmap.lfile_file_style_blue);
                break;
            case Constant.ICON_STYLE_GREEN:
                imageView.setBackgroundResource(com.leon.lfilepickerlibrary.R.mipmap.lfile_file_style_green);
                break;
            case Constant.ICON_STYLE_YELLOW:
                imageView.setBackgroundResource(com.leon.lfilepickerlibrary.R.mipmap.lfile_file_style_yellow);
                break;
        }
    }
    ...
    class PathViewHolder extends RecyclerView.ViewHolder {
        ...
        public PathViewHolder(View itemView) {
            super(itemView);
            ivType = (ImageView) itemView.findViewById(com.leon.lfilepickerlibrary.R.id.iv_type);
            layoutRoot = (RelativeLayout) itemView.findViewById(com.leon.lfilepickerlibrary.R.id.layout_item_root);
            tvName = (TextView) itemView.findViewById(com.leon.lfilepickerlibrary.R.id.tv_name);
            tvDetail = (TextView) itemView.findViewById(com.leon.lfilepickerlibrary.R.id.tv_detail);
            cbChoose = (CheckBox) itemView.findViewById(com.leon.lfilepickerlibrary.R.id.cb_choose);
        }
    }
}
